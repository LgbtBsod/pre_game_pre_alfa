...
class UI:
	def __init__(self, game_data_manager: Optional[GameDataManager] = None):
		...
		self.magic_graphics = []
		if game_data_manager:
			magic_spells = game_data_manager.get_all_magic()
