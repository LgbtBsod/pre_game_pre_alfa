...
class AttributeTemplateManager:
                ...
                with sqlite3.connect(db_path) as conn:
                    ...
                    for row in rows:
                        try:
                            ...
                            logger.warning(f"Ошибка загрузки шаблона атрибута {row[0]}: {e}")
                            continue
    ...
    def _create_default_templates(self):
        ...
        default_templates = {
            "str_001": AttributeTemplate("str_001", "Сила", "Увеличивает физический урон", 10.0, 100.0, 1.0, "physical", {"damage_output": 2.0}),
            "dex_001": AttributeTemplate("dex_001", "Ловкость", "Увеличивает точность", 10.0, 100.0, 1.0, "physical", {"critical_chance": 0.01}),
            "int_001": AttributeTemplate("int_001", "Интеллект", "Увеличивает магический урон", 10.0, 100.0, 1.0, "magical", {"magic_damage": 2.0}),
            "vit_001": AttributeTemplate("vit_001", "Живучесть", "Увеличивает здоровье", 10.0, 100.0, 1.0, "survival", {"max_health": 20.0}),
            "end_001": AttributeTemplate("end_001", "Выносливость", "Увеличивает выносливость", 10.0, 100.0, 1.0, "survival", {"max_stamina": 15.0}),
            "fai_001": AttributeTemplate("fai_001", "Вера", "Увеличивает священную магию", 10.0, 100.0, 1.0, "magical", {"holy_damage": 2.0}),
            "luc_001": AttributeTemplate("luc_001", "Удача", "Увеличивает критический шанс", 10.0, 100.0, 1.0, "utility", {"critical_chance": 0.005})
        }
    ...
    def create_attribute_from_template(self, template_id: str, level: int = 1) -> Optional[Attribute]:
