...
class LevelingSystem:
    ...
    def __init__(self, entity):
        ...
        from config.unified_settings import get_leveling_settings

        leveling_settings = get_leveling_settings()

        self.base_attributes = {
            AttributeType.STRENGTH: leveling_settings.BASE_STRENGTH,
            AttributeType.DEXTERITY: leveling_settings.BASE_DEXTERITY,
            AttributeType.INTELLIGENCE: leveling_settings.BASE_INTELLIGENCE,
            AttributeType.VITALITY: leveling_settings.BASE_VITALITY,
            AttributeType.ENDURANCE: leveling_settings.BASE_ENDURANCE,
            AttributeType.FAITH: leveling_settings.BASE_FAITH,
            AttributeType.LUCK: leveling_settings.BASE_LUCK,
        }
        ...
        self.leveling_config = {
            "exp_scaling": leveling_settings.EXP_SCALING,
            "attribute_points_per_level": leveling_settings.ATTRIBUTE_POINTS_PER_LEVEL,
            "skill_points_per_level": leveling_settings.SKILL_POINTS_PER_LEVEL,
            "max_level": leveling_settings.MAX_LEVEL,
            "bonus_levels": leveling_settings.BONUS_LEVELS,
        }
    ...
    def gain_experience(self, amount: int) -> bool:
        ...
        while (
            ...
            and self.level < self.leveling_config["max_level"]
        ):
            self._level_up()
            leveled_up = True
    ...
    def remove_attribute_bonus(self, attribute: AttributeType, source: str):
        ...
        self.attribute_bonuses[attribute] = [
            bonus
            for bonus in self.attribute_bonuses[attribute]
    ...
    def reset_attributes(self, cost: int = 0) -> bool:
        ...
        if (
            cost > 0
            and hasattr(self.entity, "currency")
            and self.entity.currency < cost
        ):
            return False
    ...
    def save_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "skill_points": self.skill_points,
            "base_attributes": {
                attr.value: value for attr, value in self.base_attributes.items()
            },
    ...
    def load_state(self, state: Dict[str, Any]):
        ...
        self.experience_to_next = state.get(
            "experience_to_next", self._calculate_exp_requirement(2)
        )
