...
from config.game_constants import (
    ...
    BACKGROUND,
    ENEMY_COUNT_EASY,
    ENEMY_LEVEL_MIN_EASY,
    ENEMY_LEVEL_MAX_EASY,
    ENEMY_COUNT_NORMAL,
    ENEMY_LEVEL_MIN_NORMAL,
    ENEMY_LEVEL_MAX_NORMAL,
    ENEMY_COUNT_HARD,
    ENEMY_LEVEL_MIN_HARD,
    ENEMY_LEVEL_MAX_HARD,
    BOSS_LEVEL_EASY,
    BOSS_LEVEL_NORMAL,
    BOSS_LEVEL_HARD,
    BASE_DAMAGE,
...
def example_entity_creation():
    ...
    enemy_pack = EntityFactory.create_enemy_pack(
        pack_size=3, level=3, center_position=(400, 400)
    )
    ...
    boss_with_minions = EntityFactory.create_boss_with_minions(
        boss_level=20, minion_count=5, center_position=(500, 500)
    )
...
def example_game_constants():
    ...
    logger.info(
        f"  Легкая: {ENEMY_COUNT_EASY} врагов, уровни {ENEMY_LEVEL_MIN_EASY}-{ENEMY_LEVEL_MAX_EASY}"
    )
    logger.info(
        f"  Нормальная: {ENEMY_COUNT_NORMAL} врагов, уровни {ENEMY_LEVEL_MIN_NORMAL}-{ENEMY_LEVEL_MAX_NORMAL}"
    )
    logger.info(
        f"  Сложная: {ENEMY_COUNT_HARD} врагов, уровни {ENEMY_LEVEL_MIN_HARD}-{ENEMY_LEVEL_MAX_HARD}"
    )
