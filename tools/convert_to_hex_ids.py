...
from utils.entity_id_generator import (
    EntityType, convert_legacy_id, legacy_converter, id_generator
)
...
class JSONConverter:
    ...
    def _determine_entity_type_from_data(self, entity_data: Dict[str, Any]) -> EntityType:
    ...
    def _convert_related_ids(self, data: Dict[str, Any], parent_type: EntityType) -> Dict[str, Any]:
