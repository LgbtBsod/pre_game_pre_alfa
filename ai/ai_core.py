...
class AICore:
    ...
    def __init__(self, entity):
        ...
        logger.info(f"AI Core инициализирован для {entity.name}")
    ...
    def _minimal_update(self, delta_time: float, current_time: float):
        ...
        if hasattr(self.entity, 'health') and self.entity.health < self.entity.max_health * 0.3:
    ...
    def _calculate_opportunity_level(self) -> float:
        ...
        try:
            ...
            if hasattr(self.entity, 'skills'):
                available_skills = [s for s in self.entity.skills.values() 
                                  if self._can_use_skill(s)]
    ...
    def _can_use_skill(self, skill) -> bool:
        ...
        try:
            # Проверка ресурсов
            if hasattr(self.entity, 'mana') and skill.get('mana_cost', 0) > self.entity.mana:
                return False
            
            if hasattr(self.entity, 'stamina') and skill.get('stamina_cost', 0) > self.entity.stamina:
                return False
    ...
    def _plan_actions(self):
        ...
        if self.priority == AIPriority.CRITICAL:
            ...
            elif hasattr(self.entity, 'health') and self.entity.health < self.entity.max_health * 0.3:
    ...
    def _execute_defend(self):
        ...
        try:
            ...
            if hasattr(self.entity, 'skills'):
                defensive_skills = [s for s in self.entity.skills.values() 
    ...
    def _execute_heal(self):
        ...
        try:
            ...
            if hasattr(self.entity, 'skills'):
                healing_skills = [s for s in self.entity.skills.values() 
    ...
    def _adapt_personality(self):
        ...
        if hasattr(self.entity, 'health') and hasattr(self.entity, 'max_health'):
            ...
            if health_ratio < 0.3:
                ...
                self.personality.aggression = max(0.1, self.personality.aggression - 0.1)
