...
class GameSystemTester:
    ...
    def _run_test(self, name: str, test_func):
        ...
        try:
            ...
            if result:
                ...
                self.results.append(TestResult(name, False, duration, "Тест вернул False"))
    ...
    def _test_ai_manager(self) -> bool:
        ...
        try:
            ...
            success = ai_manager.register_entity(enemy, enemy.ai_core if hasattr(enemy, 'ai_core') else None)
    ...
    def _test_ai_entity_registration(self) -> bool:
        ...
        try:
            ...
            for entity in entities:
                ai_manager.register_entity(entity, entity.ai_core if hasattr(entity, 'ai_core') else None)
