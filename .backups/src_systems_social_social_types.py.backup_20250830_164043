...
#!/usr / bin / env python3
"""Типы социального взаимодействия и связанные перечисления"""from enum import Enum

class RelationshipType(Enum):"""Типы отношений"""
    pass
pass
pass
pass
...
THERAPIST= "therapis t"
EMPATHY_PARTNER= "empathy_partner"
COURAGE_INSPIRER= "courage_in spirer"class InteractionType(Enum):"""Типы взаимодействий"""
...
COMFORT_PROVIDED= "comfor t_provided":
pass  # Добавлен pass в пустой блок
...
ADAPTATION_TRAINING= "adaptation_train ing"
...
WISDOM_IMPARTED= "wis dom_imparted"
EXPERIENCE_SHARED= "experience_shared"class ReputationType(Enum):"""Типы репутации"""
# Общая репутация
GENERAL= "general"
HONESTY= "honesty"
...
GENE_EXPERTISE= "gene_expertis e"
...
WISDOM_LEVEL= "wis dom_level"
# Торговая репутация
TRADING_FAIRNESS= "trading_fairness"
QUALITY_PROVIDER= "quality_provider"
PRICE_REASONABLE= "price_reasonable"
SERVICE_QUALITY= "service_quality"class SocialStatus(Enum):"""Социальный статус"""
OUTCAST= "outcast"
PEASANT= "peasant"
CITIZEN= "citizen"
MERCHANT= "merchant"
...
ROYAL= "royal"
LEGENDARY= "legendary"
MYTHIC= "mythic"class FactionType(Enum):"""Типы фракций"""
NEUTRAL= "neutral"
