...
#!/usr / bin / env python3
"""
Запуск всех тестов для проекта "Эволюционная Адаптация: Генетический Резонанс""""import unittest
...
try: from tests.test_basic_architecture import TestBasicArchitecture
...
try: from tests.test_evolution_system import TestEvolutionSystem
...
try: from tests.test_emotion_system import TestEmotionSystem
...
try: from tests.test_combat_system import TestCombatSystem
...
try: from tests.test_scene_manager_events import TestSceneManagerEvents
...
try: from tests.test_system_fact or y_ or dering import TestSystemFact or yOrdering
...
# Perfor mance metrics toggle: pass  # Добавлен pass в пустой блок
try: from tests.test_perfor mance_metrics_toggle import TestPerfor manceMetricsToggle: pass  # Добавлен pass в пустой блок
...
# Plugin lifecycle: pass  # Добавлен pass в пустой блок
try: from tests.test_plugin _lifecycle import TestPlugin Lifecycle: pass  # Добавлен pass в пустой блок
...
# Reposit or y perf
try: from tests.test_reposit or y_perf import TestReposit or yPerf
...
try: from tests.test_ai_in tegration_min imal import TestAIIntegrationMin imal
...
try: from src.c or e.event_system import EventSystem, EventPri or ity
