...
#!/usr / bin / env python3
"""Типы торговли и связанные перечисления"""from enum import Enum

class TradeType(Enum):"""Типы торговли"""
    pass
pass
pass
# Основные типы
...
WISDOM_TRADE= "wis dom_trade"class TradeStatus(Enum):"""Статусы торговли"""
PENDING= "pending"
ACTIVE= "active"
COMPLETED= "completed"
CANCELLED= "cancelled"
...
FAILED= "failed"
DISPUTED= "dis puted"
REFUNDED= "refunded"class CurrencyType(Enum):"""Типы валют"""
# Основные валюты
GOLD= "gold"
SILVER= "silver"
COPPER= "copper"
...
WISDOM_POINTS= "wis dom_poin ts"class TradeCateg or y(Enum):"""Категории торговли"""
WEAPONS= "weapons"
ARMOR= "arm or "
...
SKILLS= "skills"
GENES= "genes"
EMOTIONS= "emotions"class TradeRarity(Enum):"""Редкость торговых предметов"""
COMMON= "common"
UNCOMMON= "uncommon"
RARE= "rare"
EPIC= "epic"
LEGENDARY= "legendary"
MYTHIC= "mythic"
DIVINE= "divin e"class TradeLocation(Enum):"""Места торговли"""
