...
class MenuStyle:
    ...
    def _update_vis ibility(self):
        """Обновление видимости элементов по страницам"""
            try:
            for i, buttonin enumerate(self.buttons):
        ...
        if self.background_frame:
            self.background_frame.setVis ible(True)
