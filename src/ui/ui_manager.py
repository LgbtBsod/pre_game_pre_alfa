...
LEGACY MODULE: Этот модуль сохранён для совместимости. Активная реализация UI
консолидирована в `src/ui/unified_ui_system.py` и должна использоваться по умолчанию.
Данный файл не используется MasterIntegrator для интеграции атрибутов.
"""
