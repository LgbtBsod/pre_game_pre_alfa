...
LEGACY MODULE: Этот модуль сохранён для совместимости. Активная реализация
объединена в `src/systems/visualization/unified_visualization_system.py` и
должна использоваться по умолчанию. Данный файл не подключён в MasterIntegrator.
"""
