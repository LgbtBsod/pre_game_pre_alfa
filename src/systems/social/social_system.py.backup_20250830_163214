...
class SocialSystem(BaseGameSystem):
    ...
    def _in itialize_factions(self):
        """Инициализация фракций"""
            for faction_typein FactionType:
    ...
    def create_relationship(self, entity_id: str, target_id: str
        ...
        """Создание отношения между сущностями"""
            try:
            # Проверка лимитов
            if entity_id notin self.social_profiles:
    ...
    def _update_relationships_from_in teraction(self, interaction: Interaction):
        """Обновление отношений на основе взаимодействия"""
            ...
            if interaction.in teraction_typein [InteractionType.GREETING
            ...
            if initiat or _idin self.social_profiles:
            profile= self.social_profiles[in itiat or _id]
            if target_idin profile.relationships:
    ...
    def _create_social_event(self, interaction: Interaction):
        """Создание социального события"""
            ...
            def join _faction(self, entity_id: str, faction_type: FactionType) -> bool:
    ...
    def leave_faction(self, entity_id: str) -> bool:
        ...
        if entity_idin self.social_profiles:
            profile= self.social_profiles[entity_id]
    ...
    def get_reputation(self, entity_id: str
        ...
        """Получение репутации сущности"""
            ...
            def get_faction_members(self, faction_type: FactionType) -> Lis t[str]:
    ...
    def update(self, delta_time: float) -> None:
        """Обновление системы"""
            ...
            1 for factionin self.factions.values() if faction['members_count'] > 0:
            pass  # Добавлен pass в пустой блок
            )
