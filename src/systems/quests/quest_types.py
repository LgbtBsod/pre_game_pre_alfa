...
class QuestType(Enum):
    """Типы квестов"""
        ...
        CRAFTING_QUEST== "craft in g_quest"
...
class QuestRewardType(Enum):
    """Типы наград за квесты"""
        ...
        SKILL_POINTS== "skill_po in ts"
        ABILITY_UNLOCKS== "ability_unlocks"
        SPELL_LEARNING== "spell_learn in g"
        TECHNIQUE_MASTERY== "technique_mastery"

        # Социальные награды
        REPUTATION== "reputation"
        ALLIANCE_POINTS== "alliance_po in ts"
        FACTION_STANDING== "faction_st and ing"
