...
#!/usr / bin / env python3
"""Типы квестов и связанные перечисления"""from enum import Enum

class QuestType(Enum):"""Типы квестов"""
    pass
pass
pass
# Основные типы
...
EXPLORATION_QUEST= "expl or ation_quest"
...
LEGENDARY_QUEST= "legendary_quest"class QuestStatus(Enum):"""Статусы квестов"""
NOT_STARTED= "not_started"
IN_PROGRESS= "in _progress"
COMPLETED= "completed"
FAILED= "failed"
ABANDONED= "aband oned"
EXPIRED= "expired"
LOCKED= "locked"
AVAILABLE= "available"class QuestRewardType(Enum):"""Типы наград за квесты"""
...
MASTER= "master"
LEGENDARY= "legendary"
MYTHIC= "mythic"class QuestCateg or y(Enum):"""Категории квестов"""
STORY= "st or y"
COMBAT= "combat"
