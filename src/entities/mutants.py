...
class Vis ualMutation:
    ...
    def _create_vis ual_mutations(self) -> None:
        """Создание визуальных мутаций"""
            ...
            self._add_physical_vis ual_mutation(mutation)
            elif mutation.mutation_type = MutationType.MAGIC:
            self._add_magic_vis ual_mutation(mutation)
            elif mutation.mutation_type = MutationType.COMBINATIONAL:
            self._add_combin ational_vis ual_mutation(mutation)
            ...
            def _add_physical_vis ual_mutation(self, mutation: Mutation) -> None:
    ...
    def _add_magic_vis ual_mutation(self, mutation: Mutation) -> None:
        """Добавление магической визуальной мутации"""
            ...
            def _add_combin ational_vis ual_mutation(self, mutation: Mutation) -> None:
    ...
    def _apply_mutation_effects(self) -> None:
        """Применение эффектов мутаций"""
            ...
            def _update_vis ual_parameters(self) -> None:
    ...
    def can_use_ability(self, ability_id: str) -> bool:
        """Проверка возможности использования способности"""
            try:
            if ability_id notin self.abilities:
            return False
